    ...
    <div className="header">
      ...
      <div className="aboutMe">
        ...
        <p>
          ...
          dicta commodi officia illum similique doloremque incidunt nobis. Magni
          necessitatibus incidunt aperiam! Provident fugiat fuga esse sequi
          culpa, tempora quo.
        </p>
...
function Project({
  name = "Project Name",
  desc = "Short description of the project. Just a couple sentences will do.",
}) {
  let color = pickRandomColor();
  return (
    <div className="project">
      <div className="projectImg" style={{ backgroundColor: color }}>
        screenshot <br />
        of project
      </div>
